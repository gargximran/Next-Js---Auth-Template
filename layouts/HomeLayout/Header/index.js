...
const Header = () => {
    ...
    return (
        <header
            className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top && 'bg-white shadow-lg'}`}>
                        ...
                        <ul className="flex flex-grow justify-end items-center">
                            {
                                isLogin ? (
                                    <li>
                                        <Link href="/profile"
                                        >
                                            <a className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Profile</a></Link>
                                    </li>
                                ) : ''
                            }
